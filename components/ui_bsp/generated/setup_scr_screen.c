...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_imgbtn_set_src(ui->screen_imgbtn_1, LV_IMGBTN_STATE_RELEASED, NULL, &_wifi__alpha_100x90, NULL);
    ...
    lv_imgbtn_set_src(ui->screen_imgbtn_2, LV_IMGBTN_STATE_RELEASED, NULL, &_ble_5_alpha_100x90, NULL);
    ...
    lv_obj_set_style_text_font(ui->screen_label_13, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_label_15, &lv_font_montserratMedium_23, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_opa(ui->screen_btn_5, 153, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_list_2_item0 = lv_list_add_btn(ui->screen_list_2, &_wi_alpha_20x20, "save");
    ui->screen_list_2_item1 = lv_list_add_btn(ui->screen_list_2, &_wi_alpha_20x20, "save_1");
    ui->screen_list_2_item2 = lv_list_add_btn(ui->screen_list_2, &_wi_alpha_20x20, "save_2");
    ui->screen_list_2_item3 = lv_list_add_btn(ui->screen_list_2, &_wi_alpha_20x20, "save_3");
    ...
    ui->screen_list_2_item11 = lv_list_add_btn(ui->screen_list_2, &_wi_alpha_20x20, "save_11");
    ...
    lv_obj_set_style_bg_opa(ui->screen_btn_6, 154, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_list_1_item0 = lv_list_add_btn(ui->screen_list_1, &_bluetooth_alpha_20x16, "save");
    ui->screen_list_1_item1 = lv_list_add_btn(ui->screen_list_1, &_bluetooth_alpha_20x16, "save_1");
    ui->screen_list_1_item2 = lv_list_add_btn(ui->screen_list_1, &_bluetooth_alpha_20x16, "save_2");
    ui->screen_list_1_item3 = lv_list_add_btn(ui->screen_list_1, &_bluetooth_alpha_20x16, "save_3");
    ui->screen_list_1_item4 = lv_list_add_btn(ui->screen_list_1, &_bluetooth_alpha_20x16, "save_4");
    ui->screen_list_1_item5 = lv_list_add_btn(ui->screen_list_1, &_bluetooth_alpha_20x16, "save_5");
    ...
    lv_obj_set_style_text_font(ui->screen_label_14, &lv_font_montserratMedium_23, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_opa(ui->screen_btn_2, 153, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_opa(ui->screen_btn_1, 154, LV_PART_MAIN|LV_STATE_DEFAULT);
