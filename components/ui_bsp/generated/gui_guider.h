...
void ui_load_scr_animation(lv_ui *ui, lv_obj_t **new_scr, bool new_scr_del,
...
void ui_animation(void *var, int32_t duration, int32_t delay,
                  int32_t start_value, int32_t end_value,
                  lv_anim_path_cb_t path_cb, uint16_t repeat_cnt,
                  uint32_t repeat_delay, uint32_t playback_time,
                  uint32_t playback_delay, lv_anim_exec_xcb_t exec_cb,
...
LV_IMG_DECLARE(_second_needle_2_alpha_139x5);
LV_IMG_DECLARE(_min_needle_white_alpha_106x8);
LV_IMG_DECLARE(_hour_needle_white_alpha_78x8);
